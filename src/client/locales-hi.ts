...
export const hi: Record<string, string> = {
  ...
  settingsFileIconThemeTitle: 'फ़ाइल आइकन',
  settingsFileIconThemeDesc: 'फ़ाइल ट्री और फ़ाइल टैब के आइकन की शैली (रंगीन थीम माँग पर लोड होती है, शुरू होते समय नहीं)',
  settingsFileIconThemeBuiltin: 'अंतर्निहित (एकरंगी)',
  settingsFileIconThemeBuiltinDesc: 'स्किन टोकन के अनुसार एकरंगी आइकन, सामान्य कोड / दस्तावेज़ / मीडिया प्रकारों के लिए',
  settingsFileIconThemeColored: 'रंगीन ब्रांड आइकन',
  settingsFileIconThemeColoredDesc: 'प्रकार के अनुसार ब्रांड रंग (जैसे .tsx → React, package.json → npm); पहली बार चालू करने पर आइकन पैक लोड होता है',
