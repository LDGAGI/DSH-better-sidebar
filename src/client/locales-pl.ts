...
export const pl: Record<string, string> = {
  ...
  settingsFileIconThemeTitle: 'Ikony plików',
  settingsFileIconThemeDesc: 'Styl ikon drzewa plików i kart plików (kolorowy motyw wczytuje się na żądanie, nigdy przy starcie)',
  settingsFileIconThemeBuiltin: 'Wbudowane (monochromatyczne)',
  settingsFileIconThemeBuiltinDesc: 'Monochromatyczne ikony zgodne z tokenami motywu, dla typowych plików kodu / dokumentów / multimediów',
  settingsFileIconThemeColored: 'Kolorowe ikony marek',
  settingsFileIconThemeColoredDesc: 'Kolory marek według typu (np. .tsx → React, package.json → npm); paczka ikon wczytuje się przy pierwszym włączeniu',
