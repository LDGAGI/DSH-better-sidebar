...
export const ja: Record<string, string> = {
  ...
  settingsFileIconThemeTitle: 'ファイルアイコン',
  settingsFileIconThemeDesc: 'ファイルツリーとファイルタブのアイコンスタイル（カラーテーマは必要時に読み込み、起動時には読み込みません）',
  settingsFileIconThemeBuiltin: '標準（モノクロ）',
  settingsFileIconThemeBuiltinDesc: 'スキントークンに従うモノクロアイコン。一般的なコード / ドキュメント / メディア形式に対応',
  settingsFileIconThemeColored: 'カラーブランドアイコン',
  settingsFileIconThemeColoredDesc: '種類ごとにブランドカラーで表示（例：.tsx → React、package.json → npm）。初回有効時にアイコンパックを読み込みます',
