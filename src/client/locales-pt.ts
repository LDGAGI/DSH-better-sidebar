export const pt: Record<string, string> = {
  ...
  settingsFileIconThemeTitle: 'Ícones de arquivo',
  settingsFileIconThemeDesc: 'Estilo dos ícones da árvore de arquivos e das abas (o tema colorido é carregado sob demanda, nunca na inicialização)',
  settingsFileIconThemeBuiltin: 'Integrado (monocromático)',
  settingsFileIconThemeBuiltinDesc: 'Ícones monocromáticos guiados por tokens, para tipos comuns de código / documento / mídia',
  settingsFileIconThemeColored: 'Ícones de marca coloridos',
  settingsFileIconThemeColoredDesc: 'Cores de marca por tipo (ex.: .tsx → React, package.json → npm); o pacote é carregado ao ativar pela primeira vez',
