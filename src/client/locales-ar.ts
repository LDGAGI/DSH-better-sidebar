...
export const ar: Record<string, string> = {
  ...
  settingsFileIconThemeTitle: 'أيقونات الملفات',
  settingsFileIconThemeDesc: 'نمط الأيقونات لشجرة الملفات وتبويبات الملفات (تُحمَّل السمة الملوّنة عند الطلب، لا عند بدء التشغيل)',
  settingsFileIconThemeBuiltin: 'مدمج (أحادي اللون)',
  settingsFileIconThemeBuiltinDesc: 'أيقونات أحادية اللون تتبع رموز السمة، تغطي أنواع التعليمات البرمجية والمستندات والوسائط الشائعة',
  settingsFileIconThemeColored: 'أيقونات العلامات الملوّنة',
  settingsFileIconThemeColoredDesc: 'ألوان العلامات حسب النوع (مثل .tsx → React و package.json → npm)؛ تُحمَّل حزمة الأيقونات عند أول تفعيل',
