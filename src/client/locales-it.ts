...
export const it: Record<string, string> = {
  ...
  settingsFileIconThemeTitle: 'Icone dei file',
  settingsFileIconThemeDesc: 'Stile delle icone per l\'albero dei file e le schede (il tema colorato si carica su richiesta, mai all\'avvio)',
  settingsFileIconThemeBuiltin: 'Integrato (monocromatico)',
  settingsFileIconThemeBuiltinDesc: 'Icone monocromatiche basate sui token del tema, per i tipi di codice / documento / media più comuni',
  settingsFileIconThemeColored: 'Icone di marca colorate',
  settingsFileIconThemeColoredDesc: 'Colori di marca per tipo (es. .tsx → React, package.json → npm); il pacchetto si carica alla prima attivazione',
