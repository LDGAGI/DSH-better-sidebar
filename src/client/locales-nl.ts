...
export const nl: Record<string, string> = {
  ...
  settingsFileIconThemeTitle: 'Bestandspictogrammen',
  settingsFileIconThemeDesc: 'Pictogramstijl voor de bestandsboom en bestandstabbladen (het kleurenthema wordt op verzoek geladen, nooit bij het starten)',
  settingsFileIconThemeBuiltin: 'Ingebouwd (monochroom)',
  settingsFileIconThemeBuiltinDesc: 'Monochrome pictogrammen volgens de token-regels, voor gangbare code-, document- en mediatypen',
  settingsFileIconThemeColored: 'Gekleurde merkpictogrammen',
  settingsFileIconThemeColoredDesc: 'Merkkleuren per type (bijv. .tsx → React, package.json → npm); het pictogrammenpakket wordt geladen bij de eerste activering',
