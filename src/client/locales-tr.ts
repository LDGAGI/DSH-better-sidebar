...
export const tr: Record<string, string> = {
  ...
  settingsFileIconThemeTitle: 'Dosya simgeleri',
  settingsFileIconThemeDesc: 'Dosya ağacı ve dosya sekmeleri için simge stili (renkli tema isteğe bağlı yüklenir, başlangıçta değil)',
  settingsFileIconThemeBuiltin: 'Yerleşik (tek renk)',
  settingsFileIconThemeBuiltinDesc: 'Tema belirteçlerine uyan tek renk simgeler; yaygın kod / belge / medya türlerini kapsar',
  settingsFileIconThemeColored: 'Renkli marka simgeleri',
  settingsFileIconThemeColoredDesc: 'Türe göre marka renkleri (örn. .tsx → React, package.json → npm); simge paketi ilk açılışta yüklenir',
