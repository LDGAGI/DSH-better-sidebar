...
export const id: Record<string, string> = {
  ...
  settingsFileIconThemeTitle: 'Ikon berkas',
  settingsFileIconThemeDesc: 'Gaya ikon untuk pohon berkas dan tab berkas (tema berwarna dimuat saat diperlukan, tidak saat mulai)',
  settingsFileIconThemeBuiltin: 'Bawaan (monokrom)',
  settingsFileIconThemeBuiltinDesc: 'Ikon monokrom mengikuti token tema, mencakup tipe kode / dokumen / media umum',
  settingsFileIconThemeColored: 'Ikon merek berwarna',
  settingsFileIconThemeColoredDesc: 'Warna merek per tipe (mis. .tsx → React, package.json → npm); paket ikon dimuat saat pertama diaktifkan',
