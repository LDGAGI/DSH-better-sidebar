...
/** Tasks (subagent) — the live-activity amber. */
export const tasksTabIcon: TabIcon = (size) =>
  themed(css.tasks, <VscTasklist size={size} />)
...
/** Terminal — primary ink, the shell is text. */
export const terminalTabIcon: TabIcon = (size) =>
  themed(css.terminal, <VscTerminal size={size} />)
