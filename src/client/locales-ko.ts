...
export const ko: Record<string, string> = {
  ...
  settingsFileIconThemeTitle: '파일 아이콘',
  settingsFileIconThemeDesc: '파일 트리와 파일 탭의 아이콘 스타일 (컬러 테마는 필요할 때 로드되며 시작 시에는 로드되지 않습니다)',
  settingsFileIconThemeBuiltin: '기본(단색)',
  settingsFileIconThemeBuiltinDesc: '스킨 토큰을 따르는 단색 아이콘으로 주요 코드 / 문서 / 미디어 형식을 지원합니다',
  settingsFileIconThemeColored: '컬러 브랜드 아이콘',
  settingsFileIconThemeColoredDesc: '유형별 브랜드 색상 (예: .tsx → React, package.json → npm), 처음 켤 때 아이콘 팩을 로드합니다',
