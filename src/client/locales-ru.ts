...
export const ru: Record<string, string> = {
  ...
  settingsFileIconThemeTitle: 'Значки файлов',
  settingsFileIconThemeDesc: 'Стиль значков дерева файлов и вкладок (цветная тема загружается по требованию, а не при запуске)',
  settingsFileIconThemeBuiltin: 'Встроенные (монохромные)',
  settingsFileIconThemeBuiltinDesc: 'Монохромные значки на основе токенов темы: код, документы и медиа',
  settingsFileIconThemeColored: 'Цветные значки брендов',
  settingsFileIconThemeColoredDesc: 'Цвета брендов по типу (например, .tsx → React, package.json → npm); набор значков загружается при первом включении',
