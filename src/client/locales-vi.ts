...
export const vi: Record<string, string> = {
  ...
  settingsFileIconThemeTitle: 'Biểu tượng tệp',
  settingsFileIconThemeDesc: 'Kiểu biểu tượng cho cây tệp và tab tệp (chủ đề màu được tải khi cần, không tải lúc khởi động)',
  settingsFileIconThemeBuiltin: 'Tích hợp (đơn sắc)',
  settingsFileIconThemeBuiltinDesc: 'Biểu tượng đơn sắc theo token giao diện, bao phủ các loại mã / tài liệu / media phổ biến',
  settingsFileIconThemeColored: 'Biểu tượng thương hiệu nhiều màu',
  settingsFileIconThemeColoredDesc: 'Màu thương hiệu theo loại (ví dụ .tsx → React, package.json → npm); gói biểu tượng tải trong lần bật đầu tiên',
