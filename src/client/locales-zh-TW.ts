...
export const zhTW: Record<string, string> = {
  ...
  settingsFileIconThemeTitle: '檔案圖示',
  settingsFileIconThemeDesc: '檔案樹與檔案分頁的圖示風格（彩色主題按需載入，不影響啟動）',
  settingsFileIconThemeBuiltin: '內建（單色）',
  settingsFileIconThemeBuiltinDesc: '跟隨面板權杖的單色圖示，涵蓋常見程式碼 / 文件 / 媒體類型',
  settingsFileIconThemeColored: '彩色品牌圖示',
  settingsFileIconThemeColoredDesc: '依類型顯示品牌配色圖示（如 .tsx → React、package.json → npm）；首次開啟時載入圖示套件',
