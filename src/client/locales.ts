...
export const zh = {
  ...
  settingsFileIconThemeTitle: '文件图标',
  settingsFileIconThemeDesc: '文件树与文件 tab 的图标风格（彩色主题按需加载，不影响启动）',
  settingsFileIconThemeBuiltin: '内置（单色）',
  settingsFileIconThemeBuiltinDesc: '跟随皮肤令牌的单色图标，覆盖常见代码 / 文档 / 媒体类型',
  settingsFileIconThemeColored: '彩色品牌图标',
  settingsFileIconThemeColoredDesc: '按类型显示品牌配色图标（如 .tsx → React、package.json → npm）；首次开启时加载图标包',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  settingsFileIconThemeTitle: 'File icons',
  settingsFileIconThemeDesc: 'Icon style for the file tree and file tabs (the colored theme loads on demand, never at startup)',
  settingsFileIconThemeBuiltin: 'Built-in (monochrome)',
  settingsFileIconThemeBuiltinDesc: 'Token-driven monochrome glyphs covering common code / document / media types',
  settingsFileIconThemeColored: 'Colored brand icons',
  settingsFileIconThemeColoredDesc: 'Per-type brand colors (e.g. .tsx → React, package.json → npm); the icon pack loads the first time you enable it',
