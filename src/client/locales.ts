...
export const zh = {
  ...
  orderedList: '有序列表',
  blockquote: '引用',
  visualUnsupported: '此文档包含暂不支持的 Markdown 语法，已使用源码模式以保留完整内容。',
  refresh: '刷新',
  save: '保存',
  saved: '已保存',
  unsaved: '未保存',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  visualUnsupported: 'This document uses Markdown syntax not yet supported in Writing mode. Source mode preserves it unchanged.',
  refresh: 'Refresh',
  save: 'Save',
  saved: 'Saved',
  unsaved: 'Unsaved',
