...
export const fr: Record<string, string> = {
  ...
  settingsFileIconThemeTitle: 'Icônes de fichiers',
  settingsFileIconThemeDesc: 'Style des icônes de l\'arborescence et des onglets de fichiers (le thème coloré se charge à la demande, jamais au démarrage)',
  settingsFileIconThemeBuiltin: 'Intégré (monochrome)',
  settingsFileIconThemeBuiltinDesc: 'Icônes monochromes pilotées par les jetons de thème, pour les types code / document / média courants',
  settingsFileIconThemeColored: 'Icônes de marque colorées',
  settingsFileIconThemeColoredDesc: 'Couleurs de marque par type (ex. .tsx → React, package.json → npm) ; le pack d\'icônes se charge à la première activation',
