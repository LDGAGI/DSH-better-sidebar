...
export const th: Record<string, string> = {
  ...
  settingsFileIconThemeTitle: 'ไอคอนไฟล์',
  settingsFileIconThemeDesc: 'สไตล์ไอคอนของแผนผังไฟล์และแท็บไฟล์ (ธีมสีจะโหลดเมื่อต้องการ ไม่โหลดตอนเริ่มต้น)',
  settingsFileIconThemeBuiltin: 'ในตัว (สีเดียว)',
  settingsFileIconThemeBuiltinDesc: 'ไอคอนสีเดียวตามโทเค็นธีม ครอบคลุมชนิดโค้ด / เอกสาร / สื่อทั่วไป',
  settingsFileIconThemeColored: 'ไอคอนแบรนด์แบบมีสี',
  settingsFileIconThemeColoredDesc: 'สีแบรนด์ตามชนิด (เช่น .tsx → React, package.json → npm) ชุดไอคอนจะโหลดเมื่อเปิดใช้ครั้งแรก',
