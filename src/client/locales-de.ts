...
export const de: Record<string, string> = {
  ...
  settingsFileIconThemeTitle: 'Dateisymbole',
  settingsFileIconThemeDesc: 'Symbolstil für Dateibaum und Datei-Tabs (das Farbthema lädt bei Bedarf, nie beim Start)',
  settingsFileIconThemeBuiltin: 'Integriert (einfarbig)',
  settingsFileIconThemeBuiltinDesc: 'Token-gesteuerte einfarbige Symbole für gängige Code-, Dokument- und Medientypen',
  settingsFileIconThemeColored: 'Farbige Markensymbole',
  settingsFileIconThemeColoredDesc: 'Markenfarben je Typ (z. B. .tsx → React, package.json → npm); das Icon-Paket lädt beim ersten Aktivieren',
