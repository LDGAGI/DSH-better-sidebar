export const sv: Record<string, string> = {
  ...
  settingsFileIconThemeTitle: 'Filikoner',
  settingsFileIconThemeDesc: 'Ikonstil för filträdet och filflikarna (färgtemat laddas vid behov, aldrig vid start)',
  settingsFileIconThemeBuiltin: 'Inbyggd (monokrom)',
  settingsFileIconThemeBuiltinDesc: 'Monokroma ikoner som följer temats tokens, för vanliga kod-, dokument- och mediatyper',
  settingsFileIconThemeColored: 'Färgade varumärkesikoner',
  settingsFileIconThemeColoredDesc: 'Varumärkesfärger per typ (t.ex. .tsx → React, package.json → npm); ikonpaketet laddas första gången du aktiverar det',
